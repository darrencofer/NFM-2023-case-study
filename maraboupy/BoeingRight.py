...
# property 
net1.setLowerBound(outputVars[0], 0) # turn right
#net1.setLowerBound(outputVars[0], 0.1) # turn right
#net1.setLowerBound(outputVars[0], 0.7) # turn right
#net1.setUpperBound(outputVars[0], 1.0) # turn right
...
net1.setLowerBound(inputVars[4], 0.) # intruder from right
net1.setUpperBound(inputVars[4], 0.5) # from right
net1.setLowerBound(inputVars[5], -0.5) 
net1.setUpperBound(inputVars[5], -0.5) # -90 deg
