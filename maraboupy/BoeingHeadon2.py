...
nnetFile = "../../../2021-09-09-SAC-VECTOR-LR-2.nnet"
...
#net1.setLowerBound(inputVars[2], -0.3)
#net1.setUpperBound(inputVars[2], 0.4)
...
net1.setLowerBound(inputVars[6], -1)
net1.setUpperBound(inputVars[6], -1)
net1.setLowerBound(inputVars[7], 0)
net1.setUpperBound(inputVars[7], 0)
net1.setLowerBound(inputVars[8], 1)
net1.setUpperBound(inputVars[8], 1)
