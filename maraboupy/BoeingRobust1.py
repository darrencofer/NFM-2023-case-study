...
# property 
#net1.setLowerBound(outputVars[0], 5)
net1.setUpperBound(outputVars[0], 0)

#inputs = []
#inputs = [0 for i in range(0, 7)] 
...
net1.setLowerBound(inputVars[6], 0.5)
net1.setUpperBound(inputVars[6], 0.5)
